...
server_hardware = OneviewSDK::API500::Synergy::ServerHardware.get_all(@client).first
enclosure = OneviewSDK::API500::Synergy::Enclosure.get_all(@client).first

options = {
  name: 'Scope',
  description: 'Sample Scope description'
}
scope = OneviewSDK::API500::Synergy::Scope.new(@client, options)
