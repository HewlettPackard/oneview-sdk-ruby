...
# Example: Create a plan script for an API500 Image Streamer
...
item = OneviewSDK::ImageStreamer::API500::PlanScript.new(@client, options)
...
list = OneviewSDK::ImageStreamer::API500::PlanScript.get_all(@client)
puts "\n#Listing all:"
...
item2 = OneviewSDK::ImageStreamer::API500::PlanScript.find_by(@client, uri: id).first
