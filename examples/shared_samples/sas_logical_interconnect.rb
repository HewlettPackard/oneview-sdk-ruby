...
# api_version = 300 & variant = Synergy to OneviewSDK::API300::C7000::SASLogicalInterconnect
# api_version = 500 & variant = Synergy to OneviewSDK::API500::C7000::SASLogicalInterconnect
