...
OneviewSDK::API300::Thunderbird::VolumeAttachment.find_by(@client, {}).each do |volume_attachment|
  puts "- #{volume_attachment['hostName']}"
end

# List extra unmanaged storage volumes
extra_managed_volumes = OneviewSDK::API300::Thunderbird::VolumeAttachment.get_extra_unmanaged_volumes(@client)['members']
...
volume_attachment = OneviewSDK::API300::Thunderbird::VolumeAttachment.find_by(@client, {}).first
