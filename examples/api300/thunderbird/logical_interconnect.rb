...
# Example: Explores functionalities of Logical Interconnects for API300 Thunderbird

# Finding a logical interconnect
items = OneviewSDK::API300::Thunderbird::LogicalInterconnect.find_by(@client, {})
puts "\nListing all interconnects."
items.each do |li|
  puts "\nLogical interconnect #{li['name']} was found."
end

item = OneviewSDK::API300::Thunderbird::LogicalInterconnect.find_by(@client, {}).first
...
interconnect = OneviewSDK::API300::Thunderbird::Interconnect.find_by(@client, uri: item['interconnects'].first).first
