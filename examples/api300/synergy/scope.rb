...
server_hardware = OneviewSDK::API300::Synergy::ServerHardware.get_all(@client).first
enclosure = OneviewSDK::API300::Synergy::Enclosure.get_all(@client).first

options = {
  name: 'Scope',
  description: 'Sample Scope description'
}
scope = OneviewSDK::API300::Synergy::Scope.new(@client, options)
