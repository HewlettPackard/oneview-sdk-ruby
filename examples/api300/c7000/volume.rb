...
# Set Storage System
storage_system = OneviewSDK::API300::C7000::StorageSystem.new(@client, credentials: { ip_hostname: @storage_system_ip })
storage_system.retrieve!

# Retrieve a Storage Pool
pools = OneviewSDK::API300::C7000::StoragePool.find_by(@client, storageSystemUri: storage_system[:uri])
...
volume1 = OneviewSDK::API300::C7000::Volume.new(@client, options1)
...
volume3 = OneviewSDK::API300::C7000::Volume.new(@client, options3)
...
if @unmanaged_volume_wwn
  ...
  volume4 = OneviewSDK::API300::C7000::Volume.new(@client, options4)
