...
OneviewSDK::API300::C7000::FirmwareDriver.find_by(@client, {}).each do |firmware|
  puts firmware['name']
end

spp = OneviewSDK::API300::C7000::FirmwareDriver.find_by(@client, state: 'Created', bundleType: 'SPP').first
hotfix = OneviewSDK::API300::C7000::FirmwareDriver.find_by(@client, state: 'Created', bundleType: 'Hotfix').first

custom_spp = OneviewSDK::API300::C7000::FirmwareDriver.new(@client)
