...
item = OneviewSDK::API300::C7000::PowerDevice.new(@client, name: 'Power_Device_1', ratedCapacity: 500)
...
item = OneviewSDK::API300::C7000::PowerDevice.find_by(@client, {}).first
item.utilization
...
# iPDU Discover
puts "\nDiscovering ipdu."
item2 = OneviewSDK::API300::C7000::PowerDevice.discover(@client, options)
...
ipdu_list = OneviewSDK::API300::C7000::PowerDevice.find_by(@client, 'managedBy' => { 'hostName' => @ipdu_hostname })
