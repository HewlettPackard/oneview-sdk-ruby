...
storage_pool = OneviewSDK::API300::C7000::StoragePool.find_by(@client, {}).first
raise 'ERROR: No storage pools found!' unless storage_pool
storage_system = OneviewSDK::API300::C7000::StorageSystem.find_by(@client, credentials: { ip_hostname: @storage_system_ip }).first
raise "ERROR: Storage System #{@storage_system_ip} not found!" unless storage_system

# Create Volume Template
volume_template = OneviewSDK::API300::C7000::VolumeTemplate.new(@client, options)
...
volume_template_2 = OneviewSDK::API300::C7000::VolumeTemplate.new(@client, name: options[:name])
...
matches = OneviewSDK::API300::C7000::VolumeTemplate.find_by(@client, name: options[:name])
