...
managed_sans = OneviewSDK::API300::C7000::ManagedSAN.find_by(@client, deviceManagerName: @san_manager_ip).each do |san|
  puts "- #{san['name']}"
end
...
wwn = OneviewSDK::API300::C7000::ManagedSAN.find_by(@client, {}).last['principalSwitch']

sans = OneviewSDK::API300::C7000::ManagedSAN.get_wwn(@client, wwn)
