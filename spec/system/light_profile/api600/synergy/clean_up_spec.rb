...
RSpec.describe 'Clean up fluid resource pool API600 Synergy', system: true, sequence: 1, api_version: 600, model: 'Synergy' do
  ...
  include_examples 'Clean up SystemTestExample Synergy', 'system api600 context'
end
