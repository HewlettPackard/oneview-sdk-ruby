...
RSpec.describe 'Spin up fluid resource pool API800 C7000', system: true, sequence: 1, api_version: 800, model: 'C7000' do
  ...
  include_examples 'SystemTestExample C7000', 'system api800 context'
end
