...
RSpec.describe 'Clean up fluid resource pool API800 Synergy', system: true, sequence: 1, api_version: 800, model: 'Synergy' do
  ...
  include_examples 'Clean up SystemTestExample Synergy', 'system api800 context'
end
