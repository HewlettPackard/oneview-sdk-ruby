...
RSpec.describe 'Spin up fluid resource pool API800 Synergy', system: true, sequence: 1, api_version: 800, model: 'Synergy' do
  ...
  include_examples 'SystemTestExample', 'system api800 context'
  include_examples 'SystemTestExample Synergy', 'system api800 context'
end
