...
RSpec.describe 'Spin up fluid resource pool API500 C7000', system: true, sequence: 1, api_version: 500, model: 'C7000' do
  ...
  include_examples 'SystemTestExample C7000', 'system api500 context'
end
