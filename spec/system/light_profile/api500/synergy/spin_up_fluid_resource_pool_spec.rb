...
RSpec.describe 'Spin up fluid resource pool API500 Synergy', system: true, sequence: 1, api_version: 500, model: 'Synergy' do
  ...
  include_examples 'SystemTestExample', 'system api500 context'
  include_examples 'SystemTestExample Synergy', 'system api500 context'
end
