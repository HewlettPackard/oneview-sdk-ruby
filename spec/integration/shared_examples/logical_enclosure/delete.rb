...
RSpec.shared_examples 'LogicalEnclosureDeleteExample' do |context_name, variant|
  ...
  describe '#delete' do
    ...
    it 'removes the resource', if: variant == 'Synergy' do
      item = described_class.find_by(current_client, name: LOG_ENCL1_NAME).first
