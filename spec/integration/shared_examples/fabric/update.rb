...
RSpec.shared_examples 'FabricUpdateExample' do |context_name|
  ...
  describe '#refresh' do
    it 'raises MethodUnavailable' do
      expect { item.refresh }.to raise_error(OneviewSDK::MethodUnavailable, /The method #refresh is unavailable for this resource/)
    end
  end
end
