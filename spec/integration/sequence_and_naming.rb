...
DEPENDENCIES = {
  ...
  EnclosureGroup: %i[LogicalInterconnectGroup SASLogicalInterconnectGroup],
  ...
  LogicalInterconnect: %i[Enclosure LogicalEnclosure],
  LogicalInterconnectGroup: %i[NetworkSet LIGUplinkSet],
  LogicalSwitch: [:LogicalSwitchGroup],
  LogicalSwitchGroup: [],
  ManagedSAN: [:SANManager],
  NetworkSet: %i[EthernetNetwork FCNetwork FCoENetwork],
  OSDeploymentPlan: [],
  PowerDevice: %i[ServerProfile Volume LogicalSwitch],
  Rack: [],
  SANManager: [],
  ...
  ServerProfile: %i[ServerHardware Enclosure ServerProfileTemplate],
  ServerProfileTemplate: %i[EnclosureGroup ServerHardware Volume],
  StoragePool: [:StorageSystem],
  StorageSystem: [:FCNetwork],
  Switch: [:LogicalSwitch],
  UnmanagedDevice: [],
  UplinkSet: %i[LogicalInterconnectGroup LogicalInterconnect],
  User: [],
  Volume: %i[StorageSystem StoragePool VolumeTemplate],
