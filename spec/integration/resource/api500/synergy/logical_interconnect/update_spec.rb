...
RSpec.describe OneviewSDK::API500::Synergy::LogicalInterconnect, integration: true, type: UPDATE do
  ...
  it_behaves_like 'LogicalInterconnectUpdateExample', 'integration api500 context'

  it_behaves_like 'ScopeHelperMethodsExample', OneviewSDK::API500::Synergy::Scope do
  ...
  it_behaves_like 'UplinkSetCreateExample', 'integration context' do
    ...
    let(:described_class) { OneviewSDK::API500::Synergy::UplinkSet }
  end
end
