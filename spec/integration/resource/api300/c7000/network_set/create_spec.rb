...
RSpec.describe klass, integration: true, type: CREATE, sequence: seq(klass) do
  ...
  describe '#create' do
    it 'network set withoutEthernet' do
      item = OneviewSDK::API300::C7000::NetworkSet.new($client_300)
    ...
    it 'network set with ethernet network' do
      eth1 = OneviewSDK::API300::C7000::EthernetNetwork.find_by($client_300, {}).first
      item = OneviewSDK::API300::C7000::NetworkSet.new($client_300)
    ...
    it 'network set with multiple ethernet networks' do
      eth1 = OneviewSDK::API300::C7000::EthernetNetwork.find_by($client_300, {}).first
      eth2 = OneviewSDK::API300::C7000::EthernetNetwork.find_by($client_300, {}).last
      item = OneviewSDK::API300::C7000::NetworkSet.new($client_300)
