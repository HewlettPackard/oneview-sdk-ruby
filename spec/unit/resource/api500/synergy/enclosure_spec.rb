...
RSpec.describe OneviewSDK::API500::Synergy::Enclosure do
  include_context 'shared context'

  it 'inherits from OneviewSDK::API300::Synergy::Enclosure' do
    expect(described_class).to be < OneviewSDK::API300::Synergy::Enclosure
  end
