...
extra_klass1 = OneviewSDK::API500::Synergy::EthernetNetwork
extra_klass2 = OneviewSDK::API500::Synergy::FCNetwork
extra_klass3 = OneviewSDK::API500::Synergy::FCoENetwork
RSpec.describe OneviewSDK::API500::Synergy::LogicalInterconnect do
  include_context 'shared context'

  let(:fixture_path) { 'spec/support/fixtures/unit/resource/logical_interconnect_default.json' }
  let(:log_int) { OneviewSDK::API500::Synergy::LogicalInterconnect.from_file(@client_500, fixture_path) }

  it 'inherits from OneviewSDK::API300::Synergy::LogicalInterconnect' do
    expect(described_class).to be < OneviewSDK::API300::Synergy::LogicalInterconnect
  end
