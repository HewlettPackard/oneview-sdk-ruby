...
RSpec.describe OneviewSDK::API2200::C7000::LogicalInterconnect do
  include_context 'shared context'

  let(:fixture_path) { 'spec/support/fixtures/unit/resource/logical_interconnect_default.json' }
  let(:log_int) { OneviewSDK::API2200::C7000::LogicalInterconnect.from_file(@client_2200, fixture_path) }
