...
RSpec.describe OneviewSDK::API1200::Synergy::EthernetNetwork do
  include_context 'shared context'

  it 'inherits from OneviewSDK::API1000::Synergy::EthernetNetwork' do
    expect(described_class).to be < OneviewSDK::API1000::Synergy::EthernetNetwork
  end
  ...
  describe '#bulk_create' do
    ...
    it 'returns true' do
      ...
      list = OneviewSDK::API1200::Synergy::EthernetNetwork.bulk_create(@client_1200, options)
