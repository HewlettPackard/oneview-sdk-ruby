...
RSpec.describe OneviewSDK::API300::SANManager do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      san_manager = OneviewSDK::API300::SANManager.new(@client_300)
  ...
  describe '#add' do
    it 'Should support add' do
      san_manager = OneviewSDK::API300::SANManager.new(
        @client_300,
        name: 'san_manager_1',
  ...
  describe '#remove' do
    it 'Should support remove' do
      san_manager = OneviewSDK::API300::SANManager.new(@client_300, uri: '/rest/fake')
  ...
  describe '#self.get_default_connection_info' do
    it 'Get default connection info' do
      ...
      default_connection = OneviewSDK::API300::SANManager.get_default_connection_info(@client_300, 'FCProvider_01')
