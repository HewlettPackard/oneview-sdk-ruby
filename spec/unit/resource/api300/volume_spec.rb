...
RSpec.describe OneviewSDK::API300::Volume do
  ...
  describe '#create' do
    it 'rearranges the provisioningParameters' do
      ...
      item = OneviewSDK::API300::Volume.new(@client_300, name: volume_name)
  ...
  describe '#delete' do
    it 'passes an extra header' do
      ...
      item = OneviewSDK::API300::Volume.new(@client_300, uri: '/rest/fake')
  ...
  describe 'helpers' do
    ...
    describe '#set_storage_system' do
      it 'sets the storageSystemUri' do
        @item.set_storage_system(OneviewSDK::StorageSystem.new(@client_300, uri: '/rest/fake'))
    ...
    describe '#set_storage_pool' do
      it 'sets the storagePoolUri' do
        @item.set_storage_pool(OneviewSDK::StoragePool.new(@client_300, uri: '/rest/fake'))
    ...
    describe '#set_snapshot_pool' do
      it 'sets the snapshotPoolUri' do
        @item.set_snapshot_pool(OneviewSDK::StoragePool.new(@client_300, uri: '/rest/fake'))
    ...
    describe '#get_snapshots' do
      it 'gets an array of snapshots' do
        ...
        snapshots = [OneviewSDK::API300::VolumeSnapshot.new(@client_300, snapshot_options)]
    ...
    describe '#get_attachable_volumes' do
      it 'returns an array of available volumes' do
        ...
        items = OneviewSDK::API300::Volume.get_attachable_volumes(@client_300)
