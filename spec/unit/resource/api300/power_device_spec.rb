...
RSpec.describe OneviewSDK::API300::PowerDevice do
  ...
  before :each do
    @item = OneviewSDK::API300::PowerDevice.new(@client_300, uri: '/rest/fake')
  end
  ...
  describe '#add' do
    it 'Should support add' do
      power_device = OneviewSDK::API300::PowerDevice.new(@client_300, name: 'power_device', ratedCapacity: 500)
  ...
  describe '#remove' do
    it 'Should support remove' do
      power_device = OneviewSDK::API300::PowerDevice.new(@client_300, uri: '/rest/fake')
  ...
  describe '#create' do
    it 'Should raise error if used' do
      power_device = OneviewSDK::API300::PowerDevice.new(@client_300)
  ...
  describe '#discover' do
    it 'Correct request' do
      ...
      expect(@client_300).to receive(:rest_post).with('/rest/power-devices/discover', 'body' => options)
        .and_return(FakeResponse.new({}))
      expect { OneviewSDK::API300::PowerDevice.discover(@client_300, options) }.not_to raise_error
    end
  end
  ...
  describe '#utilization' do
    it 'requires a uri' do
      expect { OneviewSDK::API300::PowerDevice.new(@client_300).utilization }.to raise_error(OneviewSDK::IncompleteResource, /Please set uri/)
    end
