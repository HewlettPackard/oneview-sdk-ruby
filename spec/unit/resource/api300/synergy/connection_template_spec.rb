...
RSpec.describe OneviewSDK::API300::Synergy::ConnectionTemplate do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      connection = OneviewSDK::API300::Synergy::ConnectionTemplate.new(@client_300)
  ...
  describe '#get_default' do
    it 'verify endpoint' do
      ...
      connection = OneviewSDK::API300::Synergy::ConnectionTemplate.get_default(@client_300)
      expect(connection).to be_an_instance_of OneviewSDK::API300::Synergy::ConnectionTemplate
    end
  end
