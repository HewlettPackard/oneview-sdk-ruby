...
RSpec.describe OneviewSDK::API300::Synergy::ServerHardwareType do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      item = OneviewSDK::API300::Synergy::ServerHardwareType.new(@client_300)
  ...
  describe '#update' do
    it 'requires a uri' do
      expect { OneviewSDK::API300::Synergy::ServerHardwareType.new(@client_300).update }.to raise_error(/Please set uri/)
    end

    it 'only includes the name and description in the PUT' do
      item = OneviewSDK::API300::Synergy::ServerHardwareType.new(@client_300, uri: '/rest/fake', name: 'Name', description: 'Desc', key: 'Val')
  ...
  describe '#remove' do
    it 'removes server hardware type' do
      item = OneviewSDK::API300::Synergy::ServerHardwareType.new(@client_300, uri: '/rest/server-hardware-types/100')
  ...
  describe 'undefined methods' do
    it 'does not allow the create action' do
      server_hardware_type = OneviewSDK::API300::Synergy::ServerHardwareType.new(@client_300)
