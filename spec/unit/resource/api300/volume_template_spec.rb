...
RSpec.describe OneviewSDK::API300::VolumeTemplate do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      profile = OneviewSDK::API300::VolumeTemplate.new(@client_300)
  ...
  describe '#create' do
    it 'adds a language header to the request' do
      item = OneviewSDK::API300::VolumeTemplate.new(@client_300, name: 'Fake')
  ...
  describe '#delete' do
    it 'adds a language header to the request' do
      item = OneviewSDK::API300::VolumeTemplate.new(@client_300, name: 'Fake', uri: '/rest/fake')
  ...
  describe '#set' do
    context 'provisioning' do
      it 'Attributes' do
        volume_template = OneviewSDK::API300::VolumeTemplate.new(@client_300)
