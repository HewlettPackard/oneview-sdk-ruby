...
RSpec.describe OneviewSDK::API300::StoragePool do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      pool = OneviewSDK::API300::StoragePool.new(@client_300)
  ...
  describe '#add' do
    it 'Should support add' do
      pool = OneviewSDK::API300::StoragePool.new(@client_300, name: 'StoragePool_1')
  ...
  describe '#remove' do
    it 'Should support remove' do
      pool = OneviewSDK::API300::StoragePool.new(@client_300, uri: '/rest/storage-pools/100')
  ...
  describe '#set_storage_system' do
    it 'sets the storageSystemUri value' do
      ...
      item.set_storage_system(OneviewSDK::API300::StorageSystem.new(@client_300, uri: '/rest/fake'))
  ...
  describe 'undefined methods' do
    ...
    it 'does not allow the update action' do
      storage_pool = OneviewSDK::API300::StoragePool.new(@client_300)
