...
RSpec.describe OneviewSDK::API300::ManagedSAN do
  ...
  describe '#create' do
    it 'is unavailable' do
      san = OneviewSDK::API300::ManagedSAN.new(@client_300)
  ...
  describe '#get_endpoints' do
    it 'List endpoints' do
      san = OneviewSDK::API300::ManagedSAN.new(@client_300, uri: '/rest/fc-sans/managed-sans/100')
