...
RSpec.describe OneviewSDK::API300::EthernetNetwork do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly api_ver 200' do
      item = OneviewSDK::API300::EthernetNetwork.new(@client_300, {}, 200)
  ...
  describe '#get_associated_profiles' do
    it 'requires a uri' do
      expect { OneviewSDK::API300::EthernetNetwork.new(@client_300).get_associated_profiles }
        .to raise_error(OneviewSDK::IncompleteResource, /Please set uri/)
    end

    it 'returns the response body from uri/associatedProfiles' do
      item = OneviewSDK::API300::EthernetNetwork.new(@client_300, uri: '/rest/fake')
  ...
  describe '#get_associated_uplink_groups' do
    it 'requires a uri' do
      expect { OneviewSDK::API300::EthernetNetwork.new(@client_300).get_associated_uplink_groups }
        .to raise_error(OneviewSDK::IncompleteResource, /Please set uri/)
    end
  ...
  describe '#bulk_create' do
    ...
    it 'returns true' do
      ...
      list = OneviewSDK::API300::EthernetNetwork.bulk_create(@client_300, options)
