...
RSpec.describe OneviewSDK::API300::UplinkSet do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      profile = OneviewSDK::API300::UplinkSet.new(@client_300)
  ...
  describe '#add_port_config' do
    it 'updates the portConfigInfos value' do
      item = OneviewSDK::API300::UplinkSet.new(@client_300)
  ...
  describe 'add elements' do
    context 'networks' do
      it 'Valid' do
        uplink = OneviewSDK::API300::UplinkSet.new(@client_300)
