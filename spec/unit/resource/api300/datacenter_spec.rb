...
RSpec.describe OneviewSDK::API300::Datacenter do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      datacenter = OneviewSDK::API300::Datacenter.new(@client_300)
  ...
  describe '#add' do
    it 'adds datacenter' do
      ...
      item = OneviewSDK::API300::Datacenter.new(@client_300, options)
  ...
  describe '#remove' do
    it 'Should support remove' do
      datacenter = OneviewSDK::API300::Datacenter.new(@client_300, uri: '/rest/datacenters/100')
