...
RSpec.describe OneviewSDK::API300::UnmanagedDevice do
  ...
  describe '#self.get_devices' do
    it 'Get unmanaged devices' do
      ...
      expect { OneviewSDK::API300::UnmanagedDevice.get_devices(@client_300) }.not_to raise_error
    end
  end

  describe '#add' do
    it 'Should support add' do
      device = OneviewSDK::API300::UnmanagedDevice.new(@client_300, name: 'UnmanagedDevice_1')
  ...
  describe '#remove' do
    it 'Should support remove' do
      device = OneviewSDK::API300::UnmanagedDevice.new(@client_300, uri: '/rest/fake')
  ...
  describe '#create' do
    it 'Should raise error if used' do
      device = OneviewSDK::API300::UnmanagedDevice.new(@client_300)
  ...
  describe '#environmentalConfiguration' do
    it 'requires a uri' do
      expect { OneviewSDK::API300::UnmanagedDevice.new(@client_300).environmental_configuration }
        .to raise_error(OneviewSDK::IncompleteResource, /Please set uri/)
    end

    it 'gets uri/environmentalConfiguration' do
      item = OneviewSDK::API300::UnmanagedDevice.new(@client_300, uri: '/rest/fake')
