...
RSpec.describe OneviewSDK::API300::C7000::Interconnect do
  ...
  describe '#get_type' do
    it 'finds the specified interconnect_type' do
      ...
      @item = OneviewSDK::API300::C7000::Interconnect.get_type(@client_300, 'Theinterconnect_type')
  ...
  describe '#name_servers' do
    it 'should get the name servers' do
      item = OneviewSDK::API300::C7000::Interconnect.new(@client_300, uri: '/rest/fake')
  ...
  describe '#update_port' do
    it 'updates an interconnect port' do
      ...
      item = OneviewSDK::API300::C7000::Interconnect.new(@client_300, options)
