...
RSpec.describe OneviewSDK::API300::C7000::ServerProfileTemplate do
  include_context 'shared context'

  it 'inherits from API200' do
    expect(described_class).to be < OneviewSDK::API200::ServerProfileTemplate
  end

  before(:each) do
    @item = OneviewSDK::API300::C7000::ServerProfileTemplate.new(@client_300, name: 'server_profile_template')
  end
  ...
  describe '#set_enclosure_group' do
    before :each do
      @enclosure_group = OneviewSDK::API300::C7000::EnclosureGroup.new(@client_300, name: 'enclosure_group')
  ...
  describe '#set_firmware_driver' do
    before :each do
      ...
      @firmware = OneviewSDK::API300::C7000::FirmwareDriver.new(@client_300, name: 'unit_firmware_driver', uri: @firmware_uri)
    end
  ...
  describe '#available_hardware' do
    it 'requires the serverHardwareTypeUri value to be set' do
      expect { OneviewSDK::API300::C7000::ServerProfileTemplate.new(@client_300).get_available_hardware }
    ...
    it 'requires the enclosureGroupUri value to be set' do
      expect { OneviewSDK::API300::C7000::ServerProfileTemplate.new(@client_300, serverHardwareTypeUri: '/rest/fake').get_available_hardware }
    ...
    it 'calls #find_by with the serverHardwareTypeUri and enclosureGroupUri' do
      @item = OneviewSDK::API300::C7000::ServerProfileTemplate.new(@client_300, serverHardwareTypeUri: '/rest/fake',
  ...
  describe '#new_profile' do
    it 'returns a profile' do
      ...
      template = OneviewSDK::API300::C7000::ServerProfileTemplate.new(@client_300, name: 'unit_server_profile_template')
  ...
  describe 'Volume attachment operations' do
    it 'can call the #add_volume_attachment using a specific already created Volume' do
      volume = OneviewSDK::API300::C7000::Volume.new(@client_300, uri: '/fake/volume',
    ...
    it 'can call #create_volume_with_attachment and generate the data required for a new Volume with attachment' do
      storage_pool = OneviewSDK::API300::C7000::StoragePool.new(@client_300, uri: 'fake/storage-pool')
      volume_options = {
        name: 'TestVolume',
