...
RSpec.describe OneviewSDK::API300::C7000::ServerHardware do
  ...
  before(:each) do
    @item = OneviewSDK::API300::C7000::ServerHardware.new(@client_300, uri: '/rest/fake')
  end

  describe '#initialize' do
    it 'sets the defaults correctly' do
      server_hardware = OneviewSDK::API300::C7000::ServerHardware.new(@client_300)
  ...
  describe '#set_refresh_state' do
    it 'requires a uri' do
      expect { OneviewSDK::API300::C7000::ServerHardware.new(@client_300).set_refresh_state(:state) }
  ...
  describe '#environmentalConfiguration' do
    it 'requires a uri' do
      expect { OneviewSDK::API300::C7000::ServerHardware.new(@client_300).environmental_configuration }
        .to raise_error(OneviewSDK::IncompleteResource, /Please set uri/)
    end
  ...
  describe '#utilization' do
    it 'requires a uri' do
      expect { OneviewSDK::API300::C7000::ServerHardware.new(@client_300).utilization }
        .to raise_error(OneviewSDK::IncompleteResource, /Please set uri/)
    end
  ...
  describe '#add' do
    context 'with valid data' do
      before :each do
        ...
        @server_hardware = OneviewSDK::API300::C7000::ServerHardware.new(@client_300, @data)
      end
  ...
  describe '#set_power_state' do
    before :each do
      @item = OneviewSDK::API300::C7000::ServerHardware.new(@client_300, uri: '/rest/fake', powerState: 'on')
      @item2 = OneviewSDK::API300::C7000::ServerHardware.new(@client_300, uri: '/rest/fake', powerState: 'off')
      allow_any_instance_of(OneviewSDK::API300::C7000::ServerHardware).to receive(:refresh).and_return(true)
    end
