...
RSpec.describe OneviewSDK::API300::C7000::LIGUplinkSet do
  ...
  describe 'adds' do
    ...
    it 'Add empty network resource' do
      upset = OneviewSDK::API300::C7000::LIGUplinkSet.new(@client_300, def_options)
    ...
    it 'Add retrieved network resource' do
      ...
      upset = OneviewSDK::API300::C7000::LIGUplinkSet.new(@client_300, options)
