...
RSpec.describe OneviewSDK::API300::C7000::FirmwareBundle do
  ...
  describe '#add' do
    it 'returns a FirmwareDriver resource' do
      ...
      expect(described_class.add(@client_300, 'file.tar').class).to eq(OneviewSDK::API300::C7000::FirmwareDriver)
    end
    ...
    it 'should call client.upload_file correctly' do
      ...
      expect(described_class.add(@client_300, 'file.tar', 100).class).to eq(OneviewSDK::API300::C7000::FirmwareDriver)
    end
  end
end
