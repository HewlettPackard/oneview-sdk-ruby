...
RSpec.describe OneviewSDK::API300::C7000::LogicalEnclosure do
  ...
  describe 'helper-methods' do
    before :each do
      @item = OneviewSDK::API300::C7000::LogicalEnclosure.new(@client_300, uri: '/rest/logical-enclosures/fake')
    end
