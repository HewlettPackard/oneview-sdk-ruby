...
RSpec.describe OneviewSDK::API300::C7000::LogicalInterconnect do
  ...
  describe '#initialize' do
    it 'requires the enclosure to have a uri value' do
      item = OneviewSDK::API300::C7000::LogicalInterconnect.new(@client_300)
  ...
  describe '#update_internal_networks' do
    ...
    it 'updates internal networks with parameters' do
      ...
      et01 = OneviewSDK::API300::C7000::EthernetNetwork.new(@client_300, uri: 'rest/fake/ethernet', name: 'et01')
      expect(@client_300).to receive(:rest_put).with(@item['uri'] + '/internalNetworks', body)
                                               .and_return(FakeResponse.new(uri: 'fake'))
  ...
  describe '#list_vlan_networks' do
    it 'lists internal networks' do
      ...
      expect(result[0]).to be_instance_of(OneviewSDK::API300::C7000::EthernetNetwork)
      expect(result[1]).to be_instance_of(OneviewSDK::API300::C7000::FCNetwork)
      expect(result[2]).to be_instance_of(OneviewSDK::API300::C7000::FCoENetwork)
  ...
  describe '#update_port_monitor' do
    it 'raises exception when is not passed the portMonitor' do
      item = OneviewSDK::API300::C7000::LogicalInterconnect.new(@client_300, uri: 'rest/fake')
    ...
    it 'updates port monitor settings' do
      item = OneviewSDK::API300::C7000::LogicalInterconnect.new(@client_300, uri: 'rest/fake', portMonitor: 'rest/fake/d1')
      update_options = {
  ...
  describe '#update_qos_configuration' do
    ...
    it 'updates QoS aggregated configuration' do
      ...
      item = OneviewSDK::API300::C7000::LogicalInterconnect.new(@client_300, options)
      update_options = {
  ...
  describe 'SNMP Configuration' do
    ...
    it 'updates SNMP Configuration' do
      item = OneviewSDK::API300::C7000::LogicalInterconnect.new(@client_300, uri: 'rest/fake', snmpConfiguration: { type: 'snmp-configuration' })
      update_options = {
  ...
  describe '#firmware_update' do
    ...
    it 'does a PUT to uri/firmware & returns the result' do
      ...
      driver = OneviewSDK::API300::C7000::FirmwareDriver.new(@client_300, name: 'FW', uri: '/rest/fake')
