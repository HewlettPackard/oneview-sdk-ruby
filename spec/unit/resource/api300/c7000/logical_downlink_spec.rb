...
RSpec.describe OneviewSDK::API300::C7000::LogicalDownlink do
  ...
  describe '#create' do
    it 'is unavailable' do
      logical_downlink = OneviewSDK::API300::C7000::LogicalDownlink.new(@client_300)
  ...
  describe '#get_without_ethernet' do
    it 'retrieve logical downlinks without ethernet' do
      ...
      logical_downlink = OneviewSDK::API300::C7000::LogicalDownlink.new(@client_300, uri: '/rest/logical-downlinks/ld1')
  ...
  describe '#self.get_without_ethernet' do
    it 'retrieve logical downlinks without ethernet' do
      ...
      logical_downlinks = OneviewSDK::API300::C7000::LogicalDownlink.get_without_ethernet(@client_300)
