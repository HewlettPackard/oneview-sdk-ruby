...
RSpec.describe OneviewSDK::API300::C7000::StorageSystem do
  ...
  describe '#host-types' do
    it 'List Host Types' do
      ...
      expect { OneviewSDK::API300::C7000::StorageSystem.get_host_types(@client_300) }.not_to raise_error
    end
  end
  ...
  describe '#set_refresh_state' do
    it 'Refreshing a storage system' do
      ...
      storage_updated = OneviewSDK::API300::C7000::StorageSystem.new(@client_300, options_update)
      allow_any_instance_of(OneviewSDK::API300::C7000::StorageSystem).to receive(:update).and_return(FakeResponse.new(storage_updated))
