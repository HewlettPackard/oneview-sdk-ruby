...
RSpec.describe OneviewSDK::API300::C7000::Datacenter do
  include_context 'shared context'

  it 'inherits from API200' do
    expect(described_class).to be < OneviewSDK::API200::Datacenter
  end

  describe '#initialize' do
    it 'sets the defaults correctly' do
      datacenter = OneviewSDK::API300::C7000::Datacenter.new(@client_300)
  ...
  describe '#add' do
    it 'adds datacenter' do
      ...
      item = OneviewSDK::API300::C7000::Datacenter.new(@client_300, options)
  ...
  describe '#remove' do
    it 'Should support remove' do
      datacenter = OneviewSDK::API300::C7000::Datacenter.new(@client_300, uri: '/rest/datacenters/100')
