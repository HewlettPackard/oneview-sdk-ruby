...
RSpec.describe OneviewSDK::API300::C7000::ServerProfile do
  ...
  describe '#set_server_hardware' do
    before :each do
      @server_hardware = OneviewSDK::API300::C7000::ServerHardware.new(@client_300, name: 'server_hardware')
    ...
    it 'will retrieve and set the serverHardwareUri correctly' do
      expect(@client_300).to receive(:rest_get).with('/rest/server-hardware')
  ...
  describe '#set_server_hardware_type' do
    before :each do
      @server_hardware_type = OneviewSDK::API300::C7000::ServerHardwareType.new(@client_300, name: 'server_hardware_type')
    ...
    it 'will retrieve and set the serverHardwareTypeUri correctly' do
      expect(@client_300).to receive(:rest_get).with('/rest/server-hardware-types')
        .and_return(FakeResponse.new(members: [
  ...
  describe '#set_enclosure_group' do
    before :each do
      @enclosure_group = OneviewSDK::EnclosureGroup.new(@client_300, name: 'enclosure_group')
  ...
  describe '#set_enclosure' do
    before :each do
      @enclosure = OneviewSDK::Enclosure.new(@client_300, name: 'enclosure')
  ...
  describe '#set_firmware_driver' do
    before :each do
      ...
      @firmware = OneviewSDK::FirmwareDriver.new(@client_300, name: 'unit_firmware_driver', uri: @firmware_uri)
    end
  ...
  describe '#self.get_available_networks' do
    it 'returns all the available networks' do
      expect(@client_300).to receive(:rest_get).with("#{OneviewSDK::API300::C7000::ServerProfile::BASE_URI}/available-networks?view=unit")
      ...
      returned_set = OneviewSDK::API300::C7000::ServerProfile.get_available_networks(@client_300, 'view' => 'unit')
  ...
  describe '#self.get_available_servers' do
    it 'retrieves available servers based on a query' do
      ...
      server_profile = OneviewSDK::API300::C7000::ServerProfile.new(@client_300, name: 'unit_server_profile', uri: server_profile_uri)
      expect(@client_300).to receive(:rest_get)
        .with("#{OneviewSDK::API300::C7000::ServerProfile::BASE_URI}/available-servers?profileUri=#{server_profile_uri}")
        .and_return(FakeResponse.new('it' => 'works'))
      expect(OneviewSDK::API300::C7000::ServerProfile.get_available_servers(@client_300, 'server_profile' => server_profile)['it'])
        .to eq('works')
    end
  end
  ...
  describe '#self.get_available_storage_system' do
    it 'retrieves available storage system based on a query' do
      ...
      expect(@client_300).to receive(:rest_get)
        .with("#{OneviewSDK::API300::C7000::ServerProfile::BASE_URI}/available-storage-system?storageSystemId=unit")
        .and_return(FakeResponse.new('it' => 'works'))
      expect(OneviewSDK::API300::C7000::ServerProfile.get_available_storage_system(@client_300, 'storage_system' => storage_system)['it'])
        .to eq('works')
    end
  end
  ...
  describe '#self.get_available_storage_systems' do
    it 'retrieves available storage system based on a query' do
      expect(@client_300).to receive(:rest_get)
        .with("#{OneviewSDK::API300::C7000::ServerProfile::BASE_URI}/available-storage-systems")
        .and_return(FakeResponse.new('it' => 'works'))
      expect(OneviewSDK::API300::C7000::ServerProfile.get_available_storage_systems(@client_300)['it']).to eq('works')
    end
  end
  ...
  describe '#self.get_available_targets' do
    it 'retrieves available targets based on a query' do
      expect(@client_300).to receive(:rest_get)
        .with("#{OneviewSDK::API300::C7000::ServerProfile::BASE_URI}/available-targets")
        .and_return(FakeResponse.new('it' => 'works'))
      expect(OneviewSDK::API300::C7000::ServerProfile.get_available_targets(@client_300)['it']).to eq('works')
    end
  end
  ...
  describe '#self.get_profile_ports' do
    it 'retrieves profile ports based on a query' do
      expect(@client_300).to receive(:rest_get)
        .with("#{OneviewSDK::API300::C7000::ServerProfile::BASE_URI}/profile-ports")
        .and_return(FakeResponse.new('it' => 'works'))
      expect(OneviewSDK::API300::C7000::ServerProfile.get_profile_ports(@client_300)['it']).to eq('works')
    end
  end

  describe '#get_compliance_preview' do
    it 'shows compliance preview' do
      expect(@client_300).to receive(:rest_get).with("#{@item['uri']}/compliance-preview")
        .and_return(FakeResponse.new('it' => 'works'))
  ...
  describe '#get_messages' do
    it 'shows messages' do
      expect(@client_300).to receive(:rest_get).with("#{@item['uri']}/messages")
        .and_return(FakeResponse.new('it' => 'works'))
  ...
  describe '#add_connection' do
    before :each do
      @item['connections'] = []
      @network = OneviewSDK::API300::C7000::EthernetNetwork.new(@client_300, name: 'unit_ethernet_network',
  ...
  describe '#get_server_hardware' do
    it 'returns nil if no hardware is assigned' do
      hw = OneviewSDK::API300::C7000::ServerProfile.new(@client_300).get_server_hardware
      expect(hw).to be_nil
    end
    ...
    it 'retrieves and returns the hardware if it is assigned' do
      ...
      hw = OneviewSDK::API300::C7000::ServerProfile.new(@client_300, serverHardwareUri: '/rest/fake').get_server_hardware
  ...
  describe '#get_available_networks' do
    it 'calls the #get_available_networks class method' do
      p = OneviewSDK::API300::C7000::ServerProfile.new(@client_300, enclosureGroupUri: '/rest/fake', serverHardwareTypeUri: '/rest/fake2')
      query = { enclosure_group_uri: p['enclosureGroupUri'], server_hardware_type_uri: p['serverHardwareTypeUri'] }
      expect(OneviewSDK::API300::C7000::ServerProfile).to receive(:get_available_networks).with(@client_300, query).and_return([])
  ...
  describe '#available_hardware' do
    it 'requires the serverHardwareTypeUri value to be set' do
      expect { OneviewSDK::API300::C7000::ServerProfile.new(@client_300).get_available_hardware }
    ...
    it 'requires the enclosureGroupUri value to be set' do
      expect { OneviewSDK::API300::C7000::ServerProfile.new(@client_300, serverHardwareTypeUri: '/rest/fake').get_available_hardware }
    ...
    it 'calls #find_by with the serverHardwareTypeUri and enclosureGroupUri' do
      @item = OneviewSDK::API300::C7000::ServerProfile.new(@client_300, serverHardwareTypeUri: '/rest/fake', enclosureGroupUri: '/rest/fake2')
  ...
  describe 'Volume attachment operations' do
    it 'can call the #add_volume_attachment using a specific already created Volume' do
      volume = OneviewSDK::Volume.new(@client_300,
                                      uri: '/fake/volume', storagePoolUri: '/fake/storage-pool', storageSystemUri: '/fake/storage-system')
    ...
    it 'can call #create_volume_with_attachment and generate the data required for a new Volume with attachment' do
      storage_pool = OneviewSDK::StoragePool.new(@client_300, uri: 'fake/storage-pool')
      volume_options = {
        name: 'TestVolume',
