...
RSpec.describe OneviewSDK::API300::C7000::VolumeSnapshot do
  ...
  describe '#initialize' do
    it 'sets the type correctly' do
      template = OneviewSDK::API300::C7000::VolumeSnapshot.new(@client_300)
  ...
  describe 'undefined methods' do
    before :each do
      @item = OneviewSDK::API300::C7000::VolumeSnapshot.new(@client_300, {})
    end
  ...
  describe 'helpers' do
    before :each do
      @item = OneviewSDK::API300::C7000::VolumeSnapshot.new(@client_300, options)
    end
