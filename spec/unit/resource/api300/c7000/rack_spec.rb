...
RSpec.describe OneviewSDK::API300::C7000::Rack do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      rack = OneviewSDK::API300::C7000::Rack.new(@client_300)
  ...
  describe '#add' do
    it 'Should support add' do
      rack = OneviewSDK::API300::C7000::Rack.new(@client_300, uri: '/rest/racks')
  ...
  describe '#remove' do
    it 'Should support remove' do
      rack = OneviewSDK::API300::C7000::Rack.new(@client_300, uri: '/rest/fake')
