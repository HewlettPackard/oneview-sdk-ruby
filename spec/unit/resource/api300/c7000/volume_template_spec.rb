...
RSpec.describe OneviewSDK::API300::C7000::VolumeTemplate do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      profile = OneviewSDK::API300::C7000::VolumeTemplate.new(@client_300)
  ...
  describe '#create' do
    it 'adds a language header to the request' do
      item = OneviewSDK::API300::C7000::VolumeTemplate.new(@client_300, name: 'Fake')
  ...
  describe '#update' do
    it 'requires a uri' do
      expect { OneviewSDK::API300::C7000::VolumeTemplate.new(@client_300).update }.to raise_error(OneviewSDK::IncompleteResource, /Please set uri/)
    end

    it 'updates the name of the volume template' do
      item = OneviewSDK::API300::C7000::VolumeTemplate.new(@client_300, uri: '/rest/fake', name: 'Fake')
  ...
  describe '#delete' do
    it 'adds a language header to the request' do
      item = OneviewSDK::API300::C7000::VolumeTemplate.new(@client_300, name: 'Fake', uri: '/rest/fake')
  ...
  describe '#set' do
    context 'provisioning' do
      it 'Attributes' do
        volume_template = OneviewSDK::API300::C7000::VolumeTemplate.new(@client_300)
