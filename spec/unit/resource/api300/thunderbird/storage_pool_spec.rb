...
RSpec.describe OneviewSDK::API300::Thunderbird::StoragePool do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      pool = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300)
  ...
  describe '#add' do
    it 'Should support add' do
      pool = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300, name: 'StoragePool_1')
  ...
  describe '#remove' do
    it 'Should support remove' do
      pool = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300, uri: '/rest/storage-pools/100')
  ...
  describe '#set_storage_system' do
    it 'sets the storageSystemUri value' do
      item = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300)
    ...
    it 'requires a storage_system with a uri' do
      item = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300)
      expect { item.set_storage_system(OneviewSDK::API300::Thunderbird::StorageSystem.new(@client_300)) }
  ...
  describe '#retrieve!' do
    it 'requires the name attribute to be set' do
      storage_pool = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300)
    ...
    it 'requires the storageSystemUri attribute to be set' do
      storage_pool = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300, name: 'StoragePoolName')
    ...
    it 'uses the uri attribute when the name is not set' do
      res = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300, uri: '/rest/fake')
      res.set_storage_system(OneviewSDK::API300::Thunderbird::StorageSystem.new(@client_300, uri: '/rest/fake'))
      expect(OneviewSDK::API300::Thunderbird::StoragePool).to receive(:find_by).with(@client_300, uri: res['uri'], storageSystemUri: '/rest/fake')
        .and_return([])
      expect(res.exists?).to eq(false)
    end

    it 'sets the data if the resource is found' do
      res = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300, name: 'ResourceName')
      res.set_storage_system(OneviewSDK::API300::Thunderbird::StorageSystem.new(@client_300, uri: '/rest/fake'))
      allow(OneviewSDK::API300::Thunderbird::StoragePool).to receive(:find_by).and_return([
        OneviewSDK::API300::Thunderbird::StoragePool.new(
          @client_300,
  ...
  describe '#exists?' do
    ...
    it 'uses the uri attribute when the name is not set' do
      res = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300, uri: '/rest/fake')
      res.set_storage_system(OneviewSDK::API300::Thunderbird::StorageSystem.new(@client_300, uri: '/rest/fake'))
      expect(OneviewSDK::API300::Thunderbird::StoragePool).to receive(:find_by).with(@client_300, storageSystemUri: '/rest/fake', uri: res['uri'])
        .and_return([])
      expect(res.exists?).to eq(false)
    end
    ...
    it 'returns true when the resource is found' do
      res = OneviewSDK::API300::Thunderbird::StoragePool.new(@client_300, name: 'ResourceName')
      res.set_storage_system(OneviewSDK::API300::Thunderbird::StorageSystem.new(@client_300, uri: '/rest/fake'))
      expect(OneviewSDK::API300::Thunderbird::StoragePool).to receive(:find_by).with(@client_300, name: res['name'], storageSystemUri: '/rest/fake')
        .and_return([res])
