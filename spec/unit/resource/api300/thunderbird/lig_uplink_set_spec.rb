...
RSpec.describe OneviewSDK::API300::Thunderbird::LIGUplinkSet do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      item = OneviewSDK::API300::Thunderbird::LIGUplinkSet.new(@client_300, networkType: 'FibreChannel')
  ...
  describe 'adds' do
    ...
    it 'Add empty network resource' do
      upset = OneviewSDK::API300::Thunderbird::LIGUplinkSet.new(@client_300, def_options)
    ...
    it 'Add retrieved network resource' do
      ...
      upset = OneviewSDK::API300::Thunderbird::LIGUplinkSet.new(@client_300, options)
