...
RSpec.describe OneviewSDK::API300::Thunderbird::LogicalSwitch do
  ...
  describe 'Validate structs' do
    ...
    it 'SNMPv3 Credentials' do
      snmp_v3 = OneviewSDK::API300::Thunderbird::LogicalSwitch::CredentialsSNMPV3.new(161, 'user',
                                                                                      'MD5',
                                                                                      'auth_password',
                                                                                      'AES128',
                                                                                      'privacy_password')
  ...
  describe '#set_switch_credentials' do
    ...
    it 'Valid structure and host for SNMPv3' do
      item = OneviewSDK::API300::Thunderbird::LogicalSwitch.new(@client_300)
      ssh_credentials = OneviewSDK::API300::Thunderbird::LogicalSwitch::CredentialsSSH.new('ssh_user', 'ssh_password')
      snmp_v3 = OneviewSDK::API300::Thunderbird::LogicalSwitch::CredentialsSNMPV3.new(161, 'public',
                                                                                      'MD5',
                                                                                      'auth_password',
                                                                                      'AES128',
                                                                                      'privacy_password')
