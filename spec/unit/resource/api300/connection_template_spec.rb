...
RSpec.describe OneviewSDK::API300::ConnectionTemplate do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly' do
      connection = OneviewSDK::API300::ConnectionTemplate.new(@client_300)
  ...
  describe '#get_default' do
    it 'verify endpoint' do
      ...
      OneviewSDK::API300::ConnectionTemplate.get_default(@client_300)
    end
  end
