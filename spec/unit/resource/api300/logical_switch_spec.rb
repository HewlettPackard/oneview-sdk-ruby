...
RSpec.describe OneviewSDK::API300::LogicalSwitch do
  ...
  describe '#initialize' do
    context 'OneView 2.0' do
      it 'sets the defaults correctly' do
        logical_switch = OneviewSDK::API300::LogicalSwitch.new(@client_300)
  ...
  describe 'Validate structs' do
    it 'SSH credentials' do
      ssh_credentials = OneviewSDK::API300::LogicalSwitch::CredentialsSSH.new('ssh_user', 'ssh_password')
      expect(ssh_credentials.user).to eq('ssh_user')
      expect(ssh_credentials.password).to eq('ssh_password')
    end

    it 'SNMPv1 Credentials' do
      snmp_v1 = OneviewSDK::API300::LogicalSwitch::CredentialsSNMPV1.new(161, 'public')
    ...
    it 'SNMPv3 Credentials' do
      snmp_v3 = OneviewSDK::API300::LogicalSwitch::CredentialsSNMPV3.new(161, 'user', 'MD5', 'auth_password', 'AES128', 'privacy_password')
  ...
  describe '#refresh' do
    it 'Refresh' do
      item = OneviewSDK::API300::LogicalSwitch.new(@client_300, uri: '/rest/fake')
  ...
  describe '#set_logical_switch_group' do
    it 'Valid logical switch group' do
      ...
      item = OneviewSDK::API300::LogicalSwitch.new(@client_300)
  ...
  describe '#set_switch_credentials' do
    ...
    it 'Valid structure and host for SNMPv3' do
      item = OneviewSDK::API300::LogicalSwitch.new(@client_300)
      ssh_credentials = OneviewSDK::API300::LogicalSwitch::CredentialsSSH.new('ssh_user', 'ssh_password')
      snmp_v3 = OneviewSDK::API300::LogicalSwitch::CredentialsSNMPV3.new(161, 'public', 'MD5', 'auth_password', 'AES128', 'privacy_password')
    ...
    it 'Invalid SSH crendential parameter' do
      item = OneviewSDK::API300::LogicalSwitch.new(@client_300)
      SSHFake_300 = Struct.new(:user, :password)
      ssh_credentials = SSHFake_300.new('ssh_user', 'ssh_password')
      snmp_v1 = OneviewSDK::API300::LogicalSwitch::CredentialsSNMPV1.new(161, 'public')
    ...
    it 'Invalid SNMP credential parameter' do
      item = OneviewSDK::API300::LogicalSwitch.new(@client_300)
      ssh_credentials = OneviewSDK::API300::LogicalSwitch::CredentialsSSH.new('ssh_user', 'ssh_password')
      SNMPFake_300 = Struct.new(:port, :community_string, :version) do
        def version
          'SNMP'
        end
      end
      snmp_v1 = SNMPFake_300.new(161, 'public')
      expect { item.set_switch_credentials('127.0.0.1', ssh_credentials, snmp_v1) }.to raise_error(
