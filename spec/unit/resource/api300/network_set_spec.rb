...
RSpec.describe OneviewSDK::API300::NetworkSet do
  ...
  describe '#initialize' do
    it 'sets the defaults correctly api_ver 200' do
      item = OneviewSDK::API300::NetworkSet.new(@client_300, {}, 200)
  ...
  describe '#set_native_network' do
    it 'sets native network for network set' do
      eth1 = OneviewSDK::API300::EthernetNetwork.new(@client_300, uri: '/rest/ethernet-networks/eth1')
      item = OneviewSDK::API300::NetworkSet.new(@client_300, {}, 300)
  ...
  describe '#add_ethernet_network' do
    ...
    it 'add multiple ethernet networks to network set' do
      eth1 = OneviewSDK::API300::EthernetNetwork.new(@client_300, uri: '/rest/ethernet-networks/eth1')
      eth2 = OneviewSDK::API300::EthernetNetwork.new(@client_300, uri: '/rest/ethernet-networks/eth2')
      item = OneviewSDK::API300::NetworkSet.new(@client_300, {}, 300)
      item.add_ethernet_network(eth1)
  ...
  describe '#get_without_ethernet' do
    it 'instance get network set without ethernet' do
      item = OneviewSDK::API300::NetworkSet.new(@client_300, uri: '/rest/network-sets/nset1')
    ...
    it 'class get network set without ethernet' do
      ...
      OneviewSDK::API300::NetworkSet.get_without_ethernet(@client_300)
    end
  end
end
