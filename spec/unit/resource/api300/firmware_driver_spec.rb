...
RSpec.describe OneviewSDK::API300::FirmwareDriver do
  ...
  describe '#remove' do
    it 'Should support remove' do
      firmware = OneviewSDK::API300::FirmwareDriver.new(@client_300, uri: '/rest/firmware-drivers/100')
  ...
  describe 'undefined methods' do
    it 'does not allow the update action' do
      item = OneviewSDK::API300::FirmwareDriver.new(@client_300, {})
