...
RSpec.describe OneviewSDK::API300::LogicalInterconnect do
  ...
  let(:log_int) { OneviewSDK::API300::LogicalInterconnect.from_file(@client_300, fixture_path) }
  ...
  describe '#create' do
    ...
    it 'makes a POST call to the base uri' do
      ...
      log_int.create(1, OneviewSDK::API300::Enclosure.new(@client_300, uri: '/rest/fake'))
    end
  end
  ...
  describe '#delete' do
    ...
    it 'makes a DELETE call to the base uri' do
      ...
      expect(@client_300).to receive(:rest_delete).with(uri, {}, log_int.api_version)
        .and_return(FakeResponse.new)
      log_int.delete(1, OneviewSDK::API300::Enclosure.new(@client_300, uri: '/rest/fake'))
    end
  end

  describe '#update_ethernet_settings' do
    it 'requires the uri to be set' do
      expect { OneviewSDK::API300::LogicalInterconnect.new(@client_300).update_ethernet_settings }
        .to raise_error(OneviewSDK::IncompleteResource, /Please set uri/)
    end

    it 'requires the ethernetSettings attribute to be set' do
      expect { OneviewSDK::API300::LogicalInterconnect.new(@client_300, uri: '/rest/fake').update_ethernet_settings }
  ...
  describe '#firmware_update' do
    it 'requires the uri to be set' do
      expect { OneviewSDK::API300::LogicalInterconnect.new(@client_300).firmware_update(:cmd, nil, {}) }
        .to raise_error(OneviewSDK::IncompleteResource, /Please set uri/)
    end
