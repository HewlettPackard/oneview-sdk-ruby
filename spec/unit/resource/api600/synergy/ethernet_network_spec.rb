...
RSpec.describe OneviewSDK::API600::Synergy::EthernetNetwork do
  include_context 'shared context'

  it 'inherits from OneviewSDK::API500::Synergy::EthernetNetwork' do
    expect(described_class).to be < OneviewSDK::API500::Synergy::EthernetNetwork
  end

  describe '#initialize' do
    it 'sets the defaults correctly api_ver 600' do
      item = OneviewSDK::API600::Synergy::EthernetNetwork.new(@client_600, {}, 200)
  ...
  describe '#bulk_create' do
    ...
    it 'returns true' do
      ...
      list = OneviewSDK::API600::Synergy::EthernetNetwork.bulk_create(@client_600, options)
