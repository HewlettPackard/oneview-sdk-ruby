...
RSpec.describe OneviewSDK::API600::Synergy::Enclosure do
  include_context 'shared context'

  it 'inherits from OneviewSDK::API500::Synergy::Enclosure' do
    expect(described_class).to be < OneviewSDK::API500::Synergy::Enclosure
  end
