...
RSpec.describe OneviewSDK::LogicalInterconnect do
  ...
  describe '#create' do
    it 'requires the enclosure to have a uri value' do
      expect { log_int.create(1, OneviewSDK::Enclosure.new(@client)) }.to raise_error(/Please set uri/)
    end
  ...
  describe '#delete' do
    it 'requires the enclosure to have a uri value' do
      expect { log_int.delete(1, OneviewSDK::Enclosure.new(@client)) }.to raise_error(/Please set uri/)
    end
  ...
  describe '#update_ethernet_settings' do
    ...
    it 'requires the ethernetSettings attribute to be set' do
      expect { OneviewSDK::LogicalInterconnect.new(@client, uri: '/rest/fake').update_ethernet_settings }.to raise_error(/Please retrieve/)
    end
  ...
  describe '#compliance' do
    it 'requires the uri to be set' do
      expect { OneviewSDK::LogicalInterconnect.new(@client).compliance }.to raise_error(/Please set uri/)
    end
  ...
  describe '#configuration' do
    it 'requires the uri to be set' do
      expect { OneviewSDK::LogicalInterconnect.new(@client).configuration }.to raise_error(/Please set uri/)
    end
  ...
  describe '#get_firmware' do
    it 'requires the uri to be set' do
      expect { OneviewSDK::LogicalInterconnect.new(@client).get_firmware }.to raise_error(/Please set uri/)
    end
  ...
  describe '#firmware_update' do
    it 'requires the uri to be set' do
      expect { OneviewSDK::LogicalInterconnect.new(@client).firmware_update(:cmd, nil, {}) }.to raise_error(/Please set uri/)
    end
  ...
  describe 'validations' do
    ...
    it 'only allows certain enet_trap_categories' do
      ...
      expect { @item.send(:validate_enet_trap_categories, ['fake']) }.to raise_error(/not.*allowed/)
    end
    ...
    it 'only allows certain fc_trap_categories' do
      ...
      expect { @item.send(:validate_fc_trap_categories, ['fake']) }.to raise_error(/not.*allowed/)
    end
    ...
    it 'only allows certain vcm_trap_categories' do
      ...
      expect { @item.send(:validate_vcm_trap_categories, ['fake']) }.to raise_error(/not.*allowed/)
    end
    ...
    it 'only allows certain trap_severities' do
      ...
      expect { @item.send(:validate_trap_severities, ['fake']) }.to raise_error(/not.*allowed/)
    end
    ...
    it 'only allows certain trap_format' do
      ...
      expect { @item.send(:validate_trap_format, 'fake') }.to raise_error(/not.*allowed/)
    end
  end
end
