  ...
  describe '#search' do
    ...
    context 'with filter' do
      ...
      it 'prints the list of resource names' do
        expect(OneviewSDK::BaseResource).to receive(:find_by).with(OneviewSDK::Client, 'description' => 'Blah')
      ...
      it 'allows attribute chaining' do
        expect(OneviewSDK::BaseResource).to receive(:find_by).with(OneviewSDK::Client, 'key1' => { 'key2' => { 'key3' => 'Blah' } })
        out = [resource_data['name'], resource_data2['name']]
    ...
    context 'with filter that needs to be parsed' do
      it 'parses booleans' do
        expect(OneviewSDK::BaseResource).to receive(:find_by).with(OneviewSDK::Client, 'description' => 'false').and_return []
        expect(OneviewSDK::BaseResource).to receive(:find_by).with(OneviewSDK::Client, 'description' => false).and_return response
        out = [resource_data['name'], resource_data2['name']]
      ...
      it 'parses integers' do
        expect(OneviewSDK::BaseResource).to receive(:find_by).with(OneviewSDK::Client, 'description' => '10').and_return []
        expect(OneviewSDK::BaseResource).to receive(:find_by).with(OneviewSDK::Client, 'description' => 10).and_return response
        out = [resource_data['name'], resource_data2['name']]
      ...
      it 'parses nil' do
        expect(OneviewSDK::BaseResource).to receive(:find_by).with(OneviewSDK::Client, 'description' => 'nil').and_return []
        expect(OneviewSDK::BaseResource).to receive(:find_by).with(OneviewSDK::Client, 'description' => nil).and_return response
        out = [resource_data['name'], resource_data2['name']]
