  ...
  module API600
    module C7000
      ...
      class Volume < OneviewSDK::API300::C7000::Volume
        ...
        #   required_attributes.each { |k| raise IncompleteResource,
        #   "Missing required attribute: '#{k}'" unless @data.key?(k) || @data.key?(k.to_sym) }
        ...
        #   storage_pool = OneviewSDK::API600::C7000::StoragePool.new(@client, uri: storage_pool_uri)
        #   raise 'StoragePool or snapshotPool must be set' unless storage_pool.retrieve!
        #   storage_system = OneviewSDK::API600::C7000::StorageSystem.new(@client, uri: storage_pool['storageSystemUri'])
